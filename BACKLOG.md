...
- 🟡 **جامعه + چالش‌های طراحی** (صفحه‌ی عمومی، لایک/کامنت/ذخیره، چالش ماهانه، رأی‌گیری، جوایز/نشان خودکار) — feed عمومی، انتشار طرح، like، comment، ذخیره/حذف ذخیره با کنترل مالکیت، moderation پنل ادمین و نمایش چالش‌ها به frontend متصل شد؛ چرخه‌ی کامل نشان/جوایز هنوز باقی است
