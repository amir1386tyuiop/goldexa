...
- 🟡 **خرید گروهی** (سرگروه، دعوت با لینک/کد، سهم هر نفر، تخفیف گروهی، پرداخت یکجا/جداگانه، پنل سرگروه) — route و UI اولیه، احراز مالکیت JWT، ایجاد گروه، join و نمایش اعضا پیاده شد؛ پرداخت wallet/checkout و workflow تکمیل سفارش هنوز باقی است
