...
- 🟡 **خرید گروهی** (سرگروه، دعوت با لینک/کد، سهم هر نفر، تخفیف گروهی، پرداخت یکجا/جداگانه، پنل سرگروه) — route و UI، احراز مالکیت JWT، ایجاد گروه، join، نمایش اعضا، پرداخت سهم با ledger اتمیک wallet و نهایی‌سازی اتمیک سفارش/قفل موجودی پیاده شد؛ افزودن محصول از UI، refund سهم‌ها و workflow حمل‌ونقل/لغو گروه هنوز باقی است
