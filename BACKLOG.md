...
- 🟡 **Smart Vault** (Digital Twin، ارزش لحظه‌ای، سود/زیان با کل مبلغ پرداختی، نمودار روند، هشدار قیمت) — محاسبه‌ی live، snapshot زمان‌بندی‌شده، نمودار ارزش و اعلان/ساخت/غیرفعال‌سازی هشدار پیاده شد؛ سیاست reset هشدار و انتخاب چنددارایی برای نمودار باقی است
...
- 🟡 **خرید گروهی** (سرگروه، دعوت با لینک/کد، سهم هر نفر، تخفیف گروهی، پرداخت یکجا/جداگانه، پنل سرگروه) — route و UI اولیه، احراز مالکیت JWT، ایجاد گروه، join، نمایش اعضا و پرداخت سهم با ledger اتمیک wallet پیاده شد؛ checkout نهایی گروه و workflow تکمیل سفارش هنوز باقی است
