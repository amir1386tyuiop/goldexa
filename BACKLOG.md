...
- ✅ گزارش‌های مالی پایه و تفکیکی (پرداخت، سفارش، escrow آزادشده، کمیسیون مزایده، بازپرداخت و payout پرداخت‌شده) — اسپرد/اشتراک/سرویس‌های بدون رکورد مالی هنوز نیازمند منبع درآمد قطعی هستند
...
- 🟡 **Smart Vault** (Digital Twin، ارزش لحظه‌ای، سود/زیان با کل مبلغ پرداختی، نمودار روند، هشدار قیمت) — محاسبه‌ی live، snapshot زمان‌بندی‌شده و اعلان هشدار پیاده شد؛ نمودار کامل و سیاست reset هشدار باقی است
