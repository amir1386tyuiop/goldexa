...
- 🟡 Monitoring: endpoint استاندارد `/metrics/prometheus`، Prometheus و Grafana در compose production-like اضافه شد و datasource/dashboard پایه‌ی Grafana provision می‌شود؛ ELK/Sentry و alerting محیط واقعی باقی است
