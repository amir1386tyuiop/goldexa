...
- 🟡 **بازار دست‌دوم + مزایده C2C** (ثبت آگهی یک‌کلیک از صندوقچه، فروش مستقیم/مزایده، بالاترین پیشنهاد، **Escrow**، تأیید کارشناس، امتیازدهی) — نیازمند WebSocket/Push و شمارش معکوس سمت سرور
...
1. ⬜ تنظیم آستانه‌ی نوسان قیمت از ۱۵٪ به **۲٪** (طبق AC دقیق PRD)
...
6. ⬜ **هشدار به ادمین** هنگام قطع منبع قیمت (نوتیفیکیشن)
