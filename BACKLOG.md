...
- 🟡 **بازار دست‌دوم + مزایده C2C** (ثبت آگهی یک‌کلیک از صندوقچه، فروش مستقیم/مزایده، بالاترین پیشنهاد، **Escrow**، تأیید کارشناس، امتیازدهی) — هسته‌ی خرید مستقیم، escrow، WebSocket، cron lifecycle، distributed lock، moderation ادمین و امتیازدهی مبتنی بر معامله پیاده شده؛ انتقال مالکیت، payout بانکی واقعی و الزامات حقوقی/عملیاتی باقی است
