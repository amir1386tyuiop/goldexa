...
- 🟡 **جامعه + چالش‌های طراحی** (صفحه‌ی عمومی، لایک/کامنت/ذخیره، چالش ماهانه، رأی‌گیری، جوایز/نشان خودکار) — feed عمومی، انتشار طرح، like، comment و نمایش چالش‌ها به frontend متصل شد؛ moderation و چرخه‌ی کامل ذخیره/نشان هنوز باقی است
