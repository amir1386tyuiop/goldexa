...
- release gate محلی برای کنترل آمادگی backend، متریک‌های Prometheus، قیمت‌گذاری، کاتالوگ، AI و routeهای کلیدی فرانت در `scripts/release-gate.mjs` قرار دارد و از ریشه با `npm run release:gate` اجرا می‌شود.
