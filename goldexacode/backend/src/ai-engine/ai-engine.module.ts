...
@Module({
  imports: [
    ...
    TypeOrmModule.forFeature([AiPricePrediction, AiDesignRecommendation, AiMarketMatch, AiServiceMetric, Role, Permission, UserRoleMapping, RolePermissionMapping, User]),
    NotificationsModule,
    ContentModule,
  ],
  controllers: [AiEngineController],
  providers: [AiEngineService, OpenRouterAiClient, RoleService, FeatureFlagGuard],
})
